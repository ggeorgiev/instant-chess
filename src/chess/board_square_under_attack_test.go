...
`)
	...
	assert.Equal(t, 1, position.BoardState.Matrix.CountSquareUnderAttackFromBlack(square.NewIndex(3, 3)))
}
...
`)
	...
	assert.Equal(t, 0, position.BoardState.Matrix.CountSquareUnderAttackFromBlack(square.NewIndex(3, 3)))
}
...
`)
	...
	assert.Equal(t, 1, position.BoardState.Matrix.CountSquareUnderAttackFromBlack(square.NewIndex(2, 1)))
}
...
`)
	...
	assert.Equal(t, 0, position.BoardState.Matrix.CountSquareUnderAttackFromBlack(square.NewIndex(4, 5)))
}
...
`)
	...
	assert.Equal(t, 16, position.BoardState.Matrix.CountSquareUnderAttackFromBlack(square.NewIndex(3, 3)))
}
