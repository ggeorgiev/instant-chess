...
`)
	...
	assert.Equal(t, 1, position.Board.SquareUnderAttackFromBlack(square.NewIndex(3, 3), 10))
}
...
`)
	...
	assert.Equal(t, 0, position.Board.SquareUnderAttackFromBlack(square.NewIndex(3, 3), 10))
}
...
`)
	...
	assert.Equal(t, 1, position.Board.SquareUnderAttackFromBlack(square.NewIndex(2, 1), 10))
}
...
`)
	...
	assert.Equal(t, 0, position.Board.SquareUnderAttackFromBlack(square.NewIndex(4, 5), 10))
}
...
`)
	...
	assert.Equal(t, 16, position.Board.SquareUnderAttackFromBlack(square.NewIndex(3, 3), 20))
}
